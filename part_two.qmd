...
When we factor this lessened vote share in, we also note that the number of "safe" seats that PH can expect to win is only `r safe_seats` out of the 222 total seats in parliament. 
...
However, it  margin by which PH/PR has won has been trending downwards. 
...
The footprint of PH is narrowing, especially with PKR focusing on [safe seats](https://www.freemalaysiatoday.com/category/nation/2026/04/16/avoiding-weak-seats-a-realistic-strategy-says-analyst).
