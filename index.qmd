...
Perikatan Nasional are anticipated to win **`r pn_safe_seats`** seats, whilst Pakatan Harapan are anticipated to only win **`r safe_seats`** seats. To have any chance at being the largest coalition, Pakatan must win all of Selangor and extend its reach into Johor and Pahang -- an unlikely occurrence. 

It is possible to re-form the Madani government. But depending on the scale of their losses and the scale of PN's victory, it might be more politically popular for BN to 

UMNO (BN) might still be able to play kingmaker, though depending on their losses and the scale of PN's victory, all other coalitions would need to join with Pakatan, 

If this holds, UMNO (BN) will once again play kingmaker, though depending on the scale of their losses, it is possible that their only choice will be Perikatan Nasional as they might not have sufficient seats to re-form the Madani government. 
