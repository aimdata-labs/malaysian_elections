...
[Liew Chin Tong](https://liewchintong.com/2020/10/21/1990-the-election-year-that-changed-malaysia/), a DAP politician, posits that 1990 was a watershed year in Malaysian politics as it was the beginning of a nearly three-decade long period of Barisan Nasional (BN) and UMNO dominance, largely led by Mahathir Mohamad. [Strong patriarchal and patronage systems](https://eastasiaforum.org/2019/05/08/patronage-based-business-as-usual-in-new-malaysia/) culminated in Mahathir Mohamad's re-election as the world's oldest Prime Minister in 2018. 

The post-1990 election period was one dominated by incumbents and long-tenured politicians, with lower participation from newer political candidates. 

Since 1990, 10 politicians have won 8 federal or state elections, including including Ku Li, who has won 12 federal and 1 state election in his career). 
...
The participation of Malay candidates in federal elections was at its lowest in the 1970s, and has been increasing every decade since, and are now higher than any time except for before the formation of the federation (when elections were limited to just the peninsula). Malay politicians' participation in state elections, conversely, now at the lowest it has ever been, largely due to the large increase in Sabah and Sarawak bumi candidates. 
...
Constitutional limits on malapportionment in Malaysia were relaxed in 1962 and removed entirely in 1973. In 2017, the Electoral Integrity Project ranked Malaysia's electoral boundaries as the most biased of the 155 countries assessed. 
...
In spite of this massive inequality in the worth of a vote, calls for redelineation have faced numerous [political challenges](https://www.iseas.edu.sg/wp-content/uploads/2024/03/ISEAS_Perspective_2024_30.pdf). Zahid Hamidi suggested that the DAP's interest in redelineation "would be unfavourable to Malays"; this was echoed by Selangor UMNO chief. 

But let's look at the data. In the plot below, we compare each races' share of the population against their share of votes. As the census does not provide a consitutuency-level breakdown of bumiputeras, we can still divide the population into East Malaysia and Peninsula. Bumiputeras in peninsula Malaysia form 54.05% of the country's population, but 52.47% of the vote share. 

Malapportionment does not benefit Malays (not that that would even be a valid argument for malapportionment). 
...
The voting power of Malays (alongside other races) have been severely compromised in numerous electoral constituencies; especially in Bangi, Kota Raja, Subang, Tebrau, Damansara, Iskandar Puteri and Shah Alam. Each of these has more than 400,000 residents being represented by only one MP. 

Additionally, the vote shares of minorities in Peninsula Malaysia are particularly compromised, with their vote shares being roughly 4/5 of what their population should command. 
...
[ISEAS](https://www.iseas.edu.sg/wp-content/uploads/2024/03/ISEAS_Perspective_2024_30.pdf) finds no evidence that malapportionment is as much of an ethnic issue as argued by UMNO. We see from their analysis that redelineation would favour PAS as much as it would the DAP. 
...
One must question whether these arguments are misguided are have been purposefully made to preserve the political power of MPs who not only represent an extremely small slice of society, have arguably not brought consistent prosperity to their constituents and have numerous opportunities for corruption given the [lack of transparency](https://theedgemalaysia.com/node/791245) of constituency development fund spending. 
...
Politically, it would be much more satisfactory to all parties to create a federal ministry for East Malaysia. This would provide an easy target for dissatisfaction in East Malaysia whilst not bogging down the federal parliament with regional issues. That this has not been considered calls into question what type of deals Anwar has made with East Malaysian parties to maintain his parliamentary majority.  
...
Further malapportionment in favour of East Malaysia will not satisfy anyone as there is no number of seats that you can give them that would allow them to outvote the peninsula. Furthermore, creating additional seats will do little to address dissatisfaction there as long as the federal government refuses the devolution of powers to the states. 
...
The chart below plots the poverty incidence and percentage of non-citizens at the federal constituency level. It is notable that many of the outliers constituencies in Sabah. 
...
Statelessness, human trafficking and low access to [public healthcare services](https://www.sciencedirect.com/science/article/abs/pii/S1521693415001595) are some of the more complex problems facing Sabah. Furthermore, whilst Sarawak has been successful in leveraging its outsized political influence, Sabah remains [politically fractured](https://www.iseas.edu.sg/wp-content/uploads/2024/11/TRS28_24.pdf), with heavier involvement from Peninsula political parties. 

To bring this back to malapportionment, it is clear that East Malaysia's grievances are more complex than can be resolved with a simple redistricting. Many areas of East Malaysia remain economically and demographically divergent from the majority of the Malaysian population indicates that Sabah's issues should be resolved regionally, as opposed to nationally, since a targeted approach is necessary and no one-size-fits-all solution exists. 

Increased federalism and greater autonomy for state governments are the correct solutions instead of further malapportionment. 
